...
# ==============================================================================
# 3. LoRA（PEFT）設定（edit_config.md推奨値に基づく最適化）
# ==============================================================================
LORA_R = 32                            # LoRAランク（edit_config.md推奨：16または32から開始）
LORA_ALPHA = 64                        # LoRAアルファ（edit_config.md推奨：2 * r）
LORA_DROPOUT = 0.05                    # LoRAドロップアウト（edit_config.md推奨）
...
# ==============================================================================
# 基本学習設定（edit_config.md推奨値）
LEARNING_RATE = 2e-4                   # AdamW学習率（edit_config.md推奨）
...
# 損失関数設定（edit_config.md推奨値）
CE_LOSS_WEIGHT = 1.0                   # テキスト生成損失の重み
DICE_LOSS_WEIGHT = 1.0                 # DICE損失の重み（0.5→1.0に変更）
BCE_LOSS_WEIGHT = 1.0                  # BCE損失の重み（2.0→1.0に変更）
