...
class CompositeLoss(nn.Module):
    ...
    def __init__(
        ...
        try:
            ...
            self.dice_loss_weight = dice_loss_weight if dice_loss_weight is not None else 1.0
            self.bce_loss_weight = bce_loss_weight if bce_loss_weight is not None else 1.0
